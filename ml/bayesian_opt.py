...
if __name__ == "__main__":
    ...
    parser.add_argument("--trials", type=int, default=10, help="Number of Bayesian optimization trials")
    args = parser.parse_args()
    
    df_opt = run_bayesian_optimization(n_trials=args.trials)
    print(df_opt[["trial", "GHSV_h", "OM_Vr_m_inv", "CO2_Conversion_pct", "MeOH_Yield_pct", "STY_kg_L_h"]].head())
