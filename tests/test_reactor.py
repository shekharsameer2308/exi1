...
def test_01_and_02_mass_and_elemental_conservation():
    ...
    res = simulate_reactor(
        temperature=493.15, pressure=50.0, total_flow=0.015, h2_co2_ratio=3.0
    )
...
def test_05_large_membrane_permeability_enhances_removal():
    ...
    res_low = simulate_reactor(
        temperature=493.15, pressure=50.0, total_flow=0.015, water_permeance=1e-8
    )
    res_high = simulate_reactor(
        temperature=493.15, pressure=50.0, total_flow=0.015, water_permeance=5e-7
    )
...
def test_08_increasing_residence_time_increases_conversion():
    ...
    res_fast = simulate_reactor(
        temperature=493.15, pressure=50.0, total_flow=0.030, h2_co2_ratio=3.0
    )
    res_slow = simulate_reactor(
        temperature=493.15, pressure=50.0, total_flow=0.010, h2_co2_ratio=3.0
    )
...
def test_11_perfect_reproducibility():
    ...
    res1 = simulate_reactor(
        temperature=493.15, pressure=50.0, total_flow=0.015, h2_co2_ratio=3.0
    )
    res2 = simulate_reactor(
        temperature=493.15, pressure=50.0, total_flow=0.015, h2_co2_ratio=3.0
    )
...
def test_12_solver_tolerance_sensitivity():
    ...
    res_std = simulate_reactor(
        temperature=493.15, pressure=50.0, total_flow=0.015, rtol=1e-6, atol=1e-9
    )
    res_tight = simulate_reactor(
        temperature=493.15, pressure=50.0, total_flow=0.015, rtol=1e-8, atol=1e-11
    )
